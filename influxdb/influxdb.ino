...
// WiFi password
#define WIFI_PASSWORD "@D2laksana"
// InfluxDB  server url. Don't use localhost, always server name or ip address.
// E.g. http://192.168.1.48:8086 (In InfluxDB 2 UI -> Load Data -> Client Libraries), 
#define INFLUXDB_URL "https://if.d2l.my.id"
// InfluxDB 2 server or cloud API authentication token (Use: InfluxDB UI -> Load Data -> Tokens -> <select token>)
#define INFLUXDB_TOKEN "qSQuouCzLsDVfoFTAanoF4ypbqy-dJKq__FYg5JqjQ1F9cdPFEXZv3k6oRrtd86lFg54Jtf1PVLTSgfv29hPWA=="
// InfluxDB 2 organization id (Use: InfluxDB UI -> Settings -> Profile -> <name under tile> )
#define INFLUXDB_ORG "D2L"
// InfluxDB 2 bucket name (Use: InfluxDB UI -> Load Data -> Buckets)
#define INFLUXDB_BUCKET "dht11"
...
void loop() {
  ...
  float suhu = random(24.5, 44.5);

  sensor.addField("temp", suhu);
